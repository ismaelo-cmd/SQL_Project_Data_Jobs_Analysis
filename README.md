# Introduction
Navigating the Data Analyst Job Market: A SQL-Driven Analysis

This project delves into the data analytics job landscape to uncover key insights for job seekers and industry professionals. 
Using SQL for data extraction and analysis, it identifies the highest-paying roles, the most sought-after skills, and the strategic intersections where high demand meets high salary. The goal is to provide a data-driven foundation for career planning and skill development.
...
![alt text](https://github.com/ismaelo-cmd/SQL_Project_Data_Jobs_Analysis/blob/15a104bcdacd5fa3cff5fab6210c63ee37c20ac7/Assets/image.png)
...
![alt text](https://github.com/ismaelo-cmd/SQL_Project_Data_Jobs_Analysis/blob/3f96c7390904f60f56eecb318742651b895bdb0c/Assets/image-1.png)

*Bar graph visualizing the count of skills for the top 10 paying jobs for data analysts; i used Excel to visualise it*
